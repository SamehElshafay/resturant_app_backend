...
class RecipeController extends Controller
{
    ...
    public function show(Recipe $recipe)
    {
        ...
        $recipe->load(['product', 'ingredients.ingredient', 'ingredients.childProduct']);
    ...
    public function edit(Recipe $recipe)
    {
        ...
        return view('recipes.edit', compact('recipe', 'products', 'ingredients', 'subProducts'));
    }
    ...
    public function update(Request $request, Recipe $recipe)
    {
        ...
        try {
            ...
            // Re-calculate cost and update ingredients
    ...
    {
        // 1. Check if product has been produced
        $produced = \App\Models\Production::where('product_id', $recipe->product_id)->exists();
        if ($produced) {
            return back()->with('error', 'Cannot delete recipe: This product has production records.');
        }

        // 2. Check if product is used as a sub-component in other recipes
        $usedAsSub = \App\Models\RecipeIngredient::where('child_product_id', $recipe->product_id)->exists();
        if ($usedAsSub) {
            return back()->with('error', 'Cannot delete recipe: This product is used as a component in other recipes.');
        }
